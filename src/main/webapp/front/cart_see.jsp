									...
									<table class="table table-bordered">
										...
										<!-- 遍历购物车中的商品并显示 -->
											...
											<tr>
												...
												<a href="${pageContext.request.contextPath}/showOneGoods?ID=${cart.id}">
													<img width="80px" src="${pageContext.request.contextPath}/images/goods/${cart.picture }"> </a></td>
												<td class="text-left name">
												<a
													href="${pageContext.request.contextPath}/showOneGoods?ID=${cart.id}"> ${cart.goodsName }</a>
												</td>
												<td class="text-left quantity">${cart.number }件</td>
												<td class="text-right price">${cart.price }元</td>
												
												<td class="text-right total">
												<a href="${pageContext.request.contextPath}/deleteCart?ID=${cart.id}">
												删除
												</a>
							...
							<div id="content_oc" class="col-sm-12">
								...
								<div class="table-responsive cart-info">
									<table class="table table-bordered">
										<tbody>
											<tr>
												<td class="text-left"><img src="${pageContext.request.contextPath}/front/images/zhifubao.png" /></td>
											</tr>
										</tbody>
									</table>
								</div>
								...
								<div class="buttons">
									<div class="pull-left">
										<a href="includeIndex.jsp" class="btn btn-primary btn-default">继续购物</a>
									</div>
									<div class="pull-left">
										<a href="${pageContext.request.contextPath}/deleteAll" class="btn btn-primary btn-default">清空购物车</a>
									</div>
	...
	<script type="text/javascript">
		function zhifu() {
			...
			var html = '<div class="popup_cont">'
					...
					+ '<image src="${pageContext.request.contextPath}/front/images/qr.png" width="256" height="256" /></div>'

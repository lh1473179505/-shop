			...
			<div class="toolbar-ct-1">
				<p>
					<i class="fa fa-phone"></i> <span style="margin-right: 15px;">电话：400-675-1066</span><a
						href="${pageContext.request.contextPath}/front/login.jsp">登录</a>&nbsp; ｜ &nbsp;<a href="register.jsp">注册</a>
				</p>
			</div>
			...
			<div class="row">
				...
				<div class="toolbar-ct toolbar-ct-right col-xs-12 col-md-3">
					...
					<div class="toolbar-ct-2 "
						...
						<a href="${pageContext.request.contextPath}/myCart" style="color: #E33737; font-size: 20px;"><i
	...
	<div style="background-color: white; width: 100%">
		<div class="container">
			<div class="row">
				<div class="toolbar-ct col-xs-12 col-md-6  hidden-sm hidden-xs">
					<div class="toolbar-ct-1">
						<img src="${pageContext.request.contextPath}/images/51logo.png">
					</div>
					<div>
						<!-- 搜索条 -->
						<div class="search_box">
							<div class="top-nav-search">
								<form method="post" action="search_result.jsp">
									<input type="text" name="searchword" size="38"
										style="border: 0px;" class="top-nav-search-input"
										placeholder="请输入内容" /> <input type="image"
										src="${pageContext.request.contextPath}/images/search.png" class="search_box_img"
										onFocus="this.blur()" />
								</form>
							</div>
						</div>

					...
					<div class="mr-megamenu animate slide" data-duration="400"
						...
						<ul class="nav navbar-nav level0">
							<li itemprop="name" data-id="435" data-level="1"><a
								id="index" itemprop="url" class="" href="${pageContext.request.contextPath}/front/includeIndex.jsp"
								data-target="#">首页 </a></li>
							<li itemprop="name" data-id="510" data-level="1"><a
								id="jingying" itemprop="url" class=""
								href="${pageContext.request.contextPath}/showGoods?type=14" data-target="#">图书类</a></li>

							<li itemprop="name" data-id="510" data-level="1"><a
								id="wenyi" itemprop="url" class="" href="${pageContext.request.contextPath}/showGoods?type=15"
								data-target="#">家电类</a></li>

							<li itemprop="name" data-id="510" data-level="1"><a
								id="jiaoyu" itemprop="url" class="" href="${pageContext.request.contextPath}/showGoods?type=16"
								data-target="#">服装类</a></li>
							<li itemprop="name" data-id="510" data-level="1"><a
								id="shenghuo" itemprop="url" class=""
								href="${pageContext.request.contextPath}/showGoods?type=17" data-target="#">电子类</a></li>
						</ul>
					</div>
